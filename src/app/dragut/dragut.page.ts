...
export class DragutPage implements OnInit {
  ...
  ionViewDidEnter() {
    ...
    const marker = L.marker([35.901252, 14.518351]).addTo(this.map);
    marker.on('click', () => {
  ...
  openAeroProject() {
    const aeroLink = "https://adobeaero.app.link/EDTfRGFkmTb"; // Replace with your actual Adobe Aero link
